...
```powershell
.\start-hotmail-helper.bat 17374
```

同时启动多个端口：

```powershell
.\start-hotmail-helper.bat 17373 17374 17375
```
...
```bash
python scripts/hotmail_helper.py --port 17374
```
...
如果你启动了多个端口，每个实例都会分别输出自己的监听地址，例如 `http://127.0.0.1:17374`、`http://127.0.0.1:17375`。
